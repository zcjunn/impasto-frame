...
2. **Source contract:** image role, semantic minimum, recognition anchors, identity/object signature, authored design anchors, transformable elements, identity fidelity, transformation mode, scene emphasis, abstraction strength, exposure key, color-authorship mode, and allowed changes.
